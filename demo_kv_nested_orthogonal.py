...
This demonstrates the same functionality as demo_nested_orthogonal.py but uses KV language
for the layout definition, making it cleaner and more declarative.
"""
