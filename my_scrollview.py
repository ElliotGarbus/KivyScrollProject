...
It makes nested scrolling more intuitive, similar to modern mobile UIs.
...
class ScrollView(StencilView):
    ...
    def on_scroll_move(self, touch):
        ...
        if ud['mode'] == 'unknown':
            ...
            # NEW: if user intent is clearly orthogonal to this SV's allowed axis,
            # yield to parent immediately.
